...
struct mmc_host_ops {
	...
	/* [yanghuaying] Reset power of SD card*/
	int	(*repower_sd)(struct mmc_host *host, int enable);
};
...
#define MMC_BUSRESUME_NEEDS_RESUME	(1 << 1)
	...
	bool perf_enable;
#endif
	/* [yanghuaying] enable repower sd when SD card ESD fail */
	int cap_repower_sd;
	int enable_repower_sd;

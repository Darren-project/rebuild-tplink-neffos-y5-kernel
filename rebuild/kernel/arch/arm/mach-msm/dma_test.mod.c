...
__attribute__((section("__versions"))) = {
	...
	{ 0xe922d90a, __VMLINUX_SYMBOL_STR(misc_deregister) },
	{ 0x2e5810c6, __VMLINUX_SYMBOL_STR(__aeabi_unwind_cpp_pr1) },
	{ 0x40972e6f, __VMLINUX_SYMBOL_STR(misc_register) },
	{ 0x1da0786, __VMLINUX_SYMBOL_STR(arm_dma_ops) },
...
MODULE_INFO(srcversion, "FC83B0B25B5EC0062597B1A");

cmd_arch/arm/boot/dts/qcom/../msm8909w-wtp.dtb := ../prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.9/bin/arm-linux-androideabi-gcc -E -Wp,-MD,arch/arm/boot/dts/qcom/../.msm8909w-wtp.dtb.d.pre.tmp -nostdinc -I/workspaces/rebuild-tplink-neffos-y5-kernel/rebuild/kernel/arch/arm/boot/dts -I/workspaces/rebuild-tplink-neffos-y5-kernel/rebuild/kernel/arch/arm/boot/dts/include -undef -D__DTS__ -x assembler-with-cpp -o arch/arm/boot/dts/qcom/../.msm8909w-wtp.dtb.dts.tmp arch/arm/boot/dts/qcom/msm8909w-wtp.dts ; /workspaces/rebuild-tplink-neffos-y5-kernel/rebuild/kernel/scripts/dtc/dtc -O dtb -o arch/arm/boot/dts/qcom/../msm8909w-wtp.dtb -b 0 -i arch/arm/boot/dts/qcom/  -d arch/arm/boot/dts/qcom/../.msm8909w-wtp.dtb.d.dtc.tmp arch/arm/boot/dts/qcom/../.msm8909w-wtp.dtb.dts.tmp ; cat arch/arm/boot/dts/qcom/../.msm8909w-wtp.dtb.d.pre.tmp arch/arm/boot/dts/qcom/../.msm8909w-wtp.dtb.d.dtc.tmp > arch/arm/boot/dts/qcom/../.msm8909w-wtp.dtb.d

source_arch/arm/boot/dts/qcom/../msm8909w-wtp.dtb := arch/arm/boot/dts/qcom/msm8909w-wtp.dts

deps_arch/arm/boot/dts/qcom/../msm8909w-wtp.dtb := \
...
arch/arm/boot/dts/qcom/../msm8909w-wtp.dtb: $(deps_arch/arm/boot/dts/qcom/../msm8909w-wtp.dtb)

...
/* [liliwen start] remove BMA2X2_SENSOR_IDENTIFICATION_ENABLE */
...
/* [liliwen start] create g-sensor on_board_info interface file (1/2) */

#define DRIVER_VERSION	"2.2.0"
/* this function will be called when the interface file has been read */
static ssize_t bma2x2_board_info_show(struct device *dev,
				       struct device_attribute *attr, char *buf)
{
	return sprintf(buf, "type:\t%s\nvendor:\t%s\ndriver_version:\t%s\n",
		"BMA-253", "Bosch", DRIVER_VERSION);
}

static DEVICE_ATTR(gravity_sensor, S_IRUGO, bma2x2_board_info_show, NULL);
/* [liliwen end] */
		...
		const struct i2c_device_id *id)
{
	...
	/* [liliwen start] create g-sensor on_board_info interface file (2/2) */
...
static int bma2x2_remove(struct i2c_client *client)
{
	...
	kfree(data);
	/* [liliwen start] remove g-sensor on_board_info interface file */
